...
public class Juego {
     ...
     * Crea el tablero, especifica el turno de juego (si empieza a jugar el jugador 1 o 2), 
     si los jugadores son humanos o la máquina.
     */
    ...
    *************************************************************/
    ...
    public void setJuego(int modoJ)
    {
        ...
        //Si el modo de juego es Humano contra máquina, crea una máquina que jugará como 
        //jugador 2.
        if(m_modoJuego == 2)
           m_maquina1 = new JugadorMaquina(2);

        //Si el modo de juego es Máquina contra máquina, crea 2 máquinas, una juega como 
        //jugador 1 y otra como 2.
    ...
    /**
     * El jugador humano realiza una tirada si es su turno, y se puede colocar la ficha 
