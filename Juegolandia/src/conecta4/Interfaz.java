...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Práctica en colaboración 2016/2017");
        setResizable(false);
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        .addContainerGap()
                        .add(jLabel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 408, 
                        Short.MAX_VALUE)
                        .add(73, 73, 73)))
                .addContainerGap())
        );
    ...
    private void jButtonHHActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_jButtonHHActionPerformed
    ...
    private void jButtonHMActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_jButtonHMActionPerformed
    ...
    private void jButtonMMActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_jButtonMMActionPerformed
    ...
    //GEN-FIRST:event_jPanel1MouseMoved
        ...
        {
            if(m_nuevoJuego.getModo() == 1 ||  
            (m_nuevoJuego.getModo()==2 && m_nuevoJuego.getTurno()==1))
            {
              ...
              anchoCasilla = (jPanel1.getSize().width-40)/m_nuevoJuego.m_tablero.numColumnas();
               ...
               //Antes de dibujar la ficha realiza un borrado por si había una ficha anterior
                    ...
                    //Dibuja la ficha
                    g.fillOval((int)(margenAncho)+(int)(columna*anchoCasilla+20), 
                    5, (int) (0.8*altoCasilla), (int) (0.8*altoCasilla));
                }
            }
        }
