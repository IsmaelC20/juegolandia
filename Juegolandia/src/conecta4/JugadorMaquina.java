...
public class JugadorMaquina extends Jugador{
     ...
     */
       ...
       ya dispongo del tablero inicial **/
...
class nodo {
    ...
    public nodo(boolean tipo,nodo padre,int jugadorInicial,int jugador,int nivel,
    int opcion,tableroAux tablero){
        this.minMax = tipo;
        this.padre = padre;
        this.valor = 0; 
        this.jugador = jugador;
    ...
    private int calcularJugada(){
       ...
       //System.out.println("fila de juego:"+tablero.devolverFilaDeJuego(columna));
        sub = this.tablero.subMatrix(this.tablero.devolverFilaDeJuego(columna,
        this.jugadorInical), columna);
       //System.out.println(this.tablero.devolverFilaDeJuego(columna,this.jugador));
           ...
           //  System.out.println();
            for(int j = 0 ; j < 3 ; ++j){
               //  System.out.print(sub[i][j]+" ");
                 //System.out.println("jugador contrario"+this.jugadorContrario());
             ...
             if(this.tablero.returnPieza(altura, this.opcion-2) == contrario){
                // System.out.println("entro a bloquear izquierda 2");
                 ...
                 if(this.tablero.returnPieza(altura, this.opcion-3) == contrario){
                  //   System.out.println("entro a bloquear tres en raya izquierda");
        ...
        if(this.tablero.returnPieza(altura, this.opcion+1) == contrario){
             if(this.tablero.returnPieza(altura, this.opcion+2) == contrario){
                 ...
                 valorBruto = valorBruto +100;
                 if(this.tablero.returnPieza(altura, this.opcion+3) == contrario){
                   //  System.out.println("entro a bloquear tres en raya derecha");
                     valorBruto = valorBruto +10000;
                  }
             }
        }
       ...
       /* 
         ...
         if(this.jugadorContrario() == this.tablero.cuatroEnRaya()){
             valorBruto = valorBruto -1000;
         }
         */
    ...
    public int extenderArbol(){
       ...
       // System.out.println("Estoy en el nodo inicial");
        ...
        // System.out.println(j);
            ...
            nodo a = new nodo(false,this,this.jugadorInical,this.jugador,this.nivel+1,j,
            this.tablero);
            a.auxExtenderArbol();
        ...
        //System.out.println("opcion bucle:"+j+":opcion en a:"+a.opcion);
           ...
           // System.out.println("valor devuelto por un nodo "+this.minMax+" : "+this.valor);
        }
           ...
           if(this.minMax){
               ...
               for(int j = 0; j < 7; ++j){
                 // System.out.println(j);
                   ...
                   nodo a = new nodo(false,this,this.jugadorInical,this.jugadorContrario(),this.nivel+1,j,this.tablero);
                   a.auxExtenderArbol();
            ...
            // System.out.println("valor devuelto por un nodo "+this.minMax+" : "+this.valor);
              ...
              // System.out.println("Entro en nodo min");
               for(int j = 0; j < 7; ++j){
                  ...
                  // System.out.println(j);
                  nodo a = new nodo(true,this,this.jugadorInical,this.jugadorContrario(),
                  this.nivel+1,j,this.tablero);
                   a.auxExtenderArbol();
             // System.out.println("valor devuelto por un nodo "+aux.minMax+" : "+aux.valor);
                  //System.out.println("opcion bucle:"+j+":opcion en a:"+a.opcion);
...
class tableroAux{
   ...
   public int devolverFilaDeJuego(int columna,int jugador){
       ...
       while(this.matrix[i][columna] != jugador && i != 0){
           System.out.println("valor de i: "+i+" Valor tablero "+this.matrix[i][columna]);
           --i;
       }
       if(i != -1){
           fila = i;
            ...
            while ((!fin) && (j < this.columnas))
            {
                ...
                if(casilla != 0)
                {
                    ...
                    if(j+3 < this.columnas)
                        ...
                        (this.matrix[i][j+2]==casilla) && (this.matrix[i][j+3]==casilla))
                        {
                            ganador = casilla;
                            fin = true;
                        }
